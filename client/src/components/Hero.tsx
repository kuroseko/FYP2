        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-white lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight ">
              Crowdfund projects with ChainFund
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
                "Empower Dreams, Fund Futures – Join the Movement of Change Makers!"
            </p>

            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
            <Link href="/campaign">
              <p
                className="px-8 py-4 text-lg font-medium text-center text-white bg-indigo-600 rounded-md shadow-xl">
                View Campaigns
              </p>
            </Link>
            <Link href="/about">
              <p
                ...
                <svg
                  ...
                  <path xmlns="http://www.w3.org/2000/svg" d="M13.7786 8.62136L6.30886 8.64017L6.31458 6.37172L17.6569 6.34314L17.6283 17.6854L15.3598 17.6911L15.3786 10.2214L7.14315 18.4569L5.54315 16.8569L13.7786 8.62136Z" />
                </svg>
              </p>
            </Link>
            </div>
